...
export interface TrajectoryInsertRequest {
   ...
   * Used by AgentMemGraph's Sessions view + recall audit log.
   */
  session_id?: string;
}
...
export class AgentMemGraphError extends Error {
  constructor(
    message: string,
    ...
    super(message);
    this.name = "AgentMemGraphError";
  }
}

export class AgentMemGraphConnectionError extends Error {
  constructor(
    message: string,
    public readonly cause?: unknown,
  ) {
    super(message);
    this.name = "AgentMemGraphConnectionError";
  }
}

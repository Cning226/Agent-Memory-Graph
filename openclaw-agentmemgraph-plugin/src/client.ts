import type { AgentMemGraphPluginConfig } from "./config.js";
...
import { AgentMemGraphError, AgentMemGraphConnectionError } from "./types.js";
...
export class AgentMemGraphClient {
  private readonly baseUrl: string;
  private readonly apiKey?: string;
  private readonly timeoutMs: number;
  private readonly maxRetries: number;

  constructor(config: AgentMemGraphPluginConfig) {
    ...
    for (let attempt = 0; attempt <= this.maxRetries; attempt++) {
      ...
      try {
        ...
        if (
          ...
          lastError = new AgentMemGraphError(
        ...
        if (err instanceof AgentMemGraphError) {
          throw err;
        }
        ...
        throw new AgentMemGraphConnectionError(

...
from agentmemgraph.api import dependencies as deps
from agentmemgraph.api.app import create_app
from agentmemgraph.clients.embedding import EmbeddingClient, AgentMemGraphEmbeddingFunction
...
def storage(chroma_client, fake_embedder):
    embed_fn = AgentMemGraphEmbeddingFunction(fake_embedder)

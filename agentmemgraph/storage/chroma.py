"""ChromaDB storage wrapper for AgentMemGraph memory graphs.
...
class ChromaStorage:
    """Manages ChromaDB collections for AgentMemGraph memory graphs."""
    ...
    def __init__(
        ...
        if embedding_function is not None:
            ...
            self._embedding_fn = AgentMemGraphEmbeddingFunction(embedding_client)
        else:

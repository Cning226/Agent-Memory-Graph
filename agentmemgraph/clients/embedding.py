...
class AgentMemGraphEmbeddingFunction:
    ...
    def get_config(self) -> dict:
        # The injected client is configured by AgentMemGraph rather than
        # reconstructed by ChromaDB.
        return {"provider": "injected"}

    @staticmethod
    def build_from_config(config: dict) -> "AgentMemGraphEmbeddingFunction":
        raise ValueError(
            "AgentMemGraphEmbeddingFunction requires an injected EmbeddingClient"
        )

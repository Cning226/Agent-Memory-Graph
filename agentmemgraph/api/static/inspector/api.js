// Tiny fetch wrapper for the AgentMemGraph API.
//
// - X-API-Key is read from localStorage (key: "agentmemgraph_api_key") if set.
// - JSON requests/responses by default.
// - Errors surface as thrown Error with .status, .body for callers to handle.

const BASE = "/api/v1";
const KEY_STORAGE = "agentmemgraph_api_key";

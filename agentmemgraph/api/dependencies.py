...
from agentmemgraph.clients.embedding import (
    EmbeddingClient,
    HTTPEmbeddingClient,
...
from agentmemgraph.config import AgentMemGraphConfig
...
@lru_cache
def get_config() -> AgentMemGraphConfig:
    """Build config from environment variables."""
    return AgentMemGraphConfig(
        ...
        api_key=os.getenv("AGENTMEMGRAPH_API_KEY"),
...
def get_llm(config: AgentMemGraphConfig | None = None) -> LLMClient | LLMRouter:
...
def get_embedder(config: AgentMemGraphConfig | None = None) -> EmbeddingClient:
...
def get_graph_manager(config: AgentMemGraphConfig | None = None) -> GraphManager:
    ...
    if _graph_manager is None:
        ...
        embed_fn = AgentMemGraphEmbeddingFunction(embedder)

...
travel-planning session at the end (mirroring how real AgentMemGraph graphs end
...
from agentmemgraph.clients.embedding import EmbeddingClient, LocalDeterministicEmbeddingClient
...
# ------------------------------------------------------------------ #
# CLI: `python -m agentmemgraph.api.demo [--reset] [--graph-id NAME]`
# ------------------------------------------------------------------ #
...
if __name__ == "__main__":  # pragma: no cover
    ...
    p = argparse.ArgumentParser(description="Seed the AgentMemGraph demo graph.")

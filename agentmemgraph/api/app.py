...
from agentmemgraph import __version__
from agentmemgraph.api.routes import demo, graphs, health, inspector, memories, retrieval
...
def create_app() -> FastAPI:
    """Build and return the AgentMemGraph FastAPI application."""

    @asynccontextmanager
    async def lifespan(app: FastAPI):
        logger.info("AgentMemGraph service v%s starting", __version__)
        yield

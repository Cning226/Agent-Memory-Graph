...
DEFAULT_EMBEDDING_MODEL_NAME = "BAAI/bge-large-en-v1.5" #"NV-Embed-v2"
DEFAULT_LLM_NAME = "qwen3.5-35b-a3b"
DEFAULT_LLM_NAME_ALIAS = ["deepseek-v4-pro",
    "qwen3.5-35b-a3b",
...
def _get_embedding_local(text: str, model_name: str = "nvidia/NV-Embed-v2"):
    ...
    if _LOCAL_EMBEDDING_MODEL is None:
        print(f"Loading local embedding model once: {model_name}")
        ...
        print("Reusing cached local embedding model")
